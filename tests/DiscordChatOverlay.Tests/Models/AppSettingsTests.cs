...
namespace OpenDash.DiscordChatOverlay.Tests.Models;
...
public class AppSettingsTests
{
    ...
    // Feature: Discord Chat Overlay, Property 1: AppSettings serialization round-trip
#if FAST_TESTS
    [Property(MaxTest = 10)]
#else
    ...
    // Feature: Discord Chat Overlay, Property 2: AppSettings defaults satisfy all range constraints
#if FAST_TESTS
    [Property(MaxTest = 10)]
#else
    [Property(MaxTest = 100)]
    ...
    // Feature: Discord Chat Overlay, Property 3: out-of-bounds position correction always yields position within monitor bounds
#if FAST_TESTS
    [Property(MaxTest = 10)]
#else
    [Property(MaxTest = 100)]
