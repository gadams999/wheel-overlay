...
namespace OpenDash.DiscordChatOverlay.Tests.Services;
...
{
    // Feature: Discord Chat Overlay, Property 1: debounce events shorter than threshold produce no state transition
#if FAST_TESTS
    [Property(MaxTest = 10)]
#else
    ...
    // Feature: Discord Chat Overlay, Property 2: debounce threshold elapsed transitions participant to Active
#if FAST_TESTS
    [Property(MaxTest = 10)]
#else
    [Property(MaxTest = 100)]
    ...
    // Feature: Discord Chat Overlay, Property 3: opacity fade monotone during grace period
#if FAST_TESTS
    [Property(MaxTest = 10)]
#else
    [Property(MaxTest = 100)]
    ...
    // Feature: Discord Chat Overlay, Property 4: grace period resumption always transitions to Active and restores opacity
#if FAST_TESTS
    [Property(MaxTest = 10)]
#else
    [Property(MaxTest = 100)]
