...
{
    // Feature: Discord Chat Overlay, Property 1: AliasService Resolve returns custom name when set, falls back to last-known name, then raw Discord name
#if FAST_TESTS
    [Property(MaxTest = 10)]
#else
    ...
    // Feature: Discord Chat Overlay, Property 2: AliasService skips and logs malformed entries without throwing
#if FAST_TESTS
    [Property(MaxTest = 10)]
#else
    [Property(MaxTest = 100)]
