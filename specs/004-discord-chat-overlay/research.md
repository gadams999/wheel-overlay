# Phase 0 Research: Discord Chat Overlay

**Date**: 2026-03-31 | **Branch**: `discord-chat-overlay/v0.1.0`
...
**Decision**: Write a custom `DiscordIpcClient` service in `src/DiscordChatOverlay/Services/`. No NuGet RPC library.
