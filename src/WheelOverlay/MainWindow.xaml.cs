...
using OpenDash.WheelOverlay.Views;
    ...
    public partial class MainWindow : Window
    {
        ...
        private void MainWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (_inputService.TestMode)
            {
                ...
                LogService.Info("Test mode: skipping process monitoring, overlay always visible");
                return;
            }
        ...
        private void InitializeProcessMonitoring()
        {
            try
            {
                ...
                LogService.Info($"Process monitoring initialized with target: {targetExe ?? "(none)"}");
            }
            catch (Exception ex)
            {
                LogService.Error("Failed to initialize process monitoring", ex);
        ...
        private void OnTargetApplicationStateChanged(object? sender, bool isRunning)
        {
            ...
            {
                LogService.Error("Error handling target application state change", ex);
        ...
        private void UpdateWindowVisibility()
        {
            ...
            {
                LogService.Error("Error updating window visibility", ex);
        ...
        public void OnProfileChanged()
        {
            try
            {
                ...
                LogService.Info($"Profile changed, target executable updated to: {targetExe ?? "(none)"}");
            }
            catch (Exception ex)
            {
                LogService.Error("Error updating process monitor target", ex);
        ...
        private void MainWindow_Closing(object? sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            LogService.Info("MainWindow closing requested - hiding window");
            e.Cancel = true;
            Hide();
        }
        ...
        private void MainWindow_Closed(object? sender, EventArgs e)
        {
            try
            {
                LogService.Info("MainWindow closed");
            ...
            {
                LogService.Error("Error disposing services", ex);
            }
        }
