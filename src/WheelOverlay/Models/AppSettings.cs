...
public enum DisplayLayout
    ...
    public class AppSettings
    {
        ...
        public static AppSettings Load()
        {
            ...
            {
                LogService.Error("Failed to load settings file, using defaults", ex);
            }
            
            // First run - no config file exists, use sensible defaults
            LogService.Info("No settings file found, creating default settings");
        ...
        public static AppSettings FromJson(string json)
        {
            try
            {
                ...
                {
                    LogService.Info("Migrating legacy settings to profile-based format");
                    var defaultProfile = new Profile
                    {
                        Name = "Default",
                ...
                foreach (var profile in settings.Profiles)
                {
                    ...
                    {
                        LogService.Info($"Invalid grid configuration in profile '{profile.Name}', adjusting to default");
            ...
            {
                LogService.Error("Failed to parse settings JSON, using defaults", ex);
